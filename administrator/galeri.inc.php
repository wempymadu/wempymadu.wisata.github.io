...
<tr>
	<td colspan="3" bgcolor="#CCCCCC" height="25" align="center">Tambah Album </td>
</tr>
	<tr>
...
<table cellpadding="1" cellspacing="1" border="0" style="margin-left:10px;">
	<tr bgcolor="#79ab2c" style="color:#FFF">
    	<td width="150" height="30">Nama Album </td>
    	<td colspan="2">&nbsp;</td>
    </tr>
    <?php
	...
	<tr bgcolor="<?php echo $bgcolor; ?>">
	  <td height="25"><a href="index.php?menu=galeri_detil&id_album=<?php echo $row[id]; ?>"><?php echo $row[nama_album]; ?></a></td>
	  <td width="50" align="center"><a href="index.php?menu=galeri&aksi=edit&id=<?php echo $row[id]; ?>"><img src="images/edit.png" border="0"/></a></td>
      <td width="50" align="center"><a href="index.php?menu=galeri&aksi=hapus&id=<?php echo $row[id]; ?>"><img src="images/delete.png" border="0"/></a></td>
  </tr>
  <?php
	}
  ?>
